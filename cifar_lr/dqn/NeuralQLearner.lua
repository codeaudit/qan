...
function nql:__init(args)
	self.state_dim  = 10*27 --512*10 --1024*5*5  --args.state_dim -- State dimensionality.
	...
	self.input_dims     = args.input_dims or {self.hist_len*self.ncols, 10, 27} --80, 64} --10, 512} --256, 100} --{self.hist_len*self.ncols, 84, 84}
