...
function nql:__init(args)
	...
	self.max_reward     = 1000--args.max_reward
	self.min_reward     = 0--args.min_reward
	...
	self.input_dims     = args.input_dims or {self.hist_len*self.ncols, 32, 25} --40, 64} --10, 512} --256, 100} --{self.hist_len*self.ncols, 84, 84}
